        ...
        <div className="hidden lg:flex w-1/2 flex-col justify-between bg-slate-900 p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-lg">
            ...
            <p className="text-lg text-slate-400">
              Log in to access real-time threat intelligence, interact with our advanced simulator, and track your awareness progress securely from one unified dashboard.
            </p>
          </div>
